...
namespace Pixeez
{
    ...
    public class Auth
    {
        ...
        public static async Task<Tokens> AuthorizeAsync(string username, string password)
        {
            ...
            AT.ME = JToken.Parse(json).SelectToken("response").ToObject<Authorize>();
           
            return new Tokens(AT.ME.AccessToken);
        }
    ...
    public class Tokens
    {
        ...
        public async Task<List<User>> GetUsersAsync(object authorId)
        {
